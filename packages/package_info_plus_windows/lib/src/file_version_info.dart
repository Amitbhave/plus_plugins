...
class FileVersionInfo {
  ...
  FileVersionInfo(this.filePath) : _data = _getData(filePath);
  ...
  static FileVersionInfoData _getData(String filePath) {
    ...
    final data = FileVersionInfoData(
      lpBlock: lpBlock,
      lpLang: Pointer<LANGANDCODEPAGE>.fromAddress(lpTranslate.value),
    );
    free(lptstrFilename);
    free(lpTranslate);
    free(lpSubBlock);
